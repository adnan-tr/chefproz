      ...
      <div className={`${direction === 'left' ? 'animate-marquee' : 'animate-marquee-reverse'} whitespace-nowrap py-4`}>
        <div className="inline-flex items-center space-x-8">
          {duplicatedBrands.map((brand, index) => (
            <div 
              key={`${brand.id}-${index}`} 
              className="inline-flex items-center space-x-4 px-6 py-2 bg-white rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow cursor-pointer"
